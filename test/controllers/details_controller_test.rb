...
class DetailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post details_url, params: { detail: { byuser: @detail.byuser, name: @detail.name, occupation: @detail.occupation, phone_number: @detail.phone_number } }
    end
  ...
  test "should update detail" do
    patch detail_url(@detail), params: { detail: { byuser: @detail.byuser, name: @detail.name, occupation: @detail.occupation, phone_number: @detail.phone_number } }
